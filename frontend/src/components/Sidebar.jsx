...
import { Video } from "lucide-react"; // Only Video is needed now
...
  // REMOVED: searchOpen, query states
  const [showOnlineOnly, setShowOnlineOnly] = useState(false);

  // FIX: Filter only by online status. No search filtering here.
...
          
          {/* Chats Title (NO search button here) */}
